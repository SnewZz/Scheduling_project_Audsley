...
class VisualizeScheduling:
	...
	def draw(self):
		...
		y = 0
		for task in self.scheduler.tasks_list: #draw the release and deadline of each jobs 
			offset = task.offset
			...
			y = y + 1
		for task in self.scheduler.tasks_list: #draw the deadlines misses 
